    ...
    <div className="container-div">
      <div className="second-container">
        ...
        <section className="my-3">
          <h1 className="text-4xl font-medium text-textColor mb-5 ">NPS Calculator</h1>
          <p className="mb-8">
            ...
            systematic savings over your working life. It's suitable for both
        ...
        <div className="space-y-14 text-gray-700 text-base leading-relaxed">
            ...
            <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
              <div>
                ...
                <p>
                  ...
                  Development Authority (PFRDA), NPS is a market-linked product
                  that aims to build a substantial retirement corpus through
                  systematic savings over your working life. It's suitable for
                  both salaried and self-employed individuals looking for a
                  disciplined approach to long-term wealth creation.
                </p>
              </div>
            ...
            <div className="space-y-4">
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100">
                ...
                <ul className="list-disc list-inside ml-4 text-sm text-gray-600">
                  ...
                  <li>
                    Employer's contribution (up to 10% of basic salary + DA) is
                    tax-deductible under <strong>Section 80CCD(2)</strong> (for
                    salaried employees).
                  </li>
                  <li>
              ...
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  instruments, leveraging the power of compounding over several
                  decades.
                </p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  You can choose your asset allocation (equity, corporate debt,
                  government securities) and select between "Active Choice" (you
                  decide allocation) or "Auto Choice" (age-based dynamic
                  allocation).
                </p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  NPS is entirely portable across jobs and locations, meaning
                  your account remains the same regardless of your employment
                  changes.
                </p>
              </div>
              <div className="bg-blue-50 p-4 rounded-lg shadow-sm border border-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  ...
                  ensures a larger portion of your contributions goes towards
                  investment growth.
                </p>
              </div>
            </div>
              ...
              <div>
                ...
                <ol className="list-decimal list-inside space-y-1">
                  <li>
                    ...
                    age. This helps determine your remaining investment period.
                  </li>
                  <li>
                    <strong>Monthly Contribution (₹):</strong> Input the amount
                    you plan to contribute to NPS each month.
                  </li>
                  <li>
                    <strong>Expected Annual Return (%):</strong> Provide your
                    estimated annual return percentage. NPS investments are
                    market-linked, so this is an estimate. (Typical range might
                    be 8-12% but is subject to market conditions).
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    assumes 40% of your maturity amount will be used to purchase
                    an annuity, as per NPS rules.
                  </li>
                  <li>
                    <strong>Expected Annuity Return:</strong> Enter the expected
                    interest rate you anticipate from your annuity plan.
                  </li>
                  <li>
                    <strong>View Your Results:</strong> The calculator will
                    instantly display your projected total investment, interest
                    earned, maturity amount, tax-free lump sum, annuity purchase
                    amount, and estimated monthly pension.
                  </li>
                </ol>
              </div>
          ...
          <section className="">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1 mt-4">
              <li>
                <strong>Total Investment:</strong> This is the cumulative sum of
                all your monthly contributions until retirement.
              </li>
              <li>
                <strong>Interest Earned:</strong> This shows the total interest
                or capital appreciation your investment is estimated to generate
                over the years, thanks to compounding.
              </li>
              <li>
                <strong>Maturity Amount:</strong> This is your total accumulated
                corpus at retirement (Current EPF Balance + Total Contributions
                + Total Interest Earned).
              </li>
              <li>
                <strong>Lump Sum Withdrawal (Tax-Free):</strong> As per current
                NPS rules, up to 60% of your maturity corpus can be withdrawn as
                a tax-free lump sum at retirement.
              </li>
              <li>
                <strong>Annuity Purchase Amount:</strong> The remaining 40% (or
                more, if you choose) of your corpus must be used to purchase an
                annuity. This amount is used by the annuity provider to give you
                a regular pension.
              </li>
              <li>
          ...
          <section className="">
            ...
            <ul className="list-disc list-inside space-y-1">
              <li>
                <strong>Eligibility:</strong> Any Indian citizen, resident or
                non-resident, between 18 and 70 years of age can open an NPS
                account.
              </li>
              <li>
                <strong>Minimum Contributions:</strong> There are minimum annual
                contribution requirements (currently ₹1,000 for Tier I).
              </li>
              <li>
              ...
              <li>
                ...
                withdrawals (up to 25% of your own contributions) are allowed
                from Tier I accounts for specific purposes (e.g., higher
                education, marriage, house purchase, critical illness) after 3
                years of opening the account, with a maximum of three
                withdrawals over the entire tenure.
              </li>
              <li>
                <strong>Mandatory Annuity:</strong> At least 40% of your
                accumulated corpus must be utilized to purchase an annuity plan
                from an Annuity Service Provider (ASP) upon attaining 60 years
                of age.
              </li>
              <li>
                <strong>Taxation of Annuity:</strong> The monthly pension
                received from the annuity is taxable as per your income tax slab
          ...
          <section className="">
            ...
            <p>
              Our <strong>NPS calculator</strong> is a versatile tool designed
              to assist a wide range of users in accurately managing their
              NPS-related projections:
            </p>
            <ul className="list-disc list-inside space-y-1">
              <li>
              ...
              <li>
                <strong>Salaried employees:</strong> To understand how NPS can
                complement their EPF/PF savings.
              </li>
              <li>
              ...
              <li>
                <strong>Anyone interested in long-term wealth creation:</strong>{" "}
          ...
          <section className="">
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                ...
                into how the mandatory annuity purchase affects your lump sum
                and pension.
              </li>
              <li>
                <strong>User-Friendly Interface:</strong> Designed for ease of
                use, making complex retirement projections simple and
                accessible.
              </li>
            </ul>
          </section>
          ...
          <section className="">
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-md shadow-sm">
              <p className="text-sm text-yellow-700">
                ...
                retirement corpus. Explore both Active and Auto Choice options
          ...
          <section id="contact" className="">
            <h2 className="text-2xl font-bold mb-3">
              Beyond Calculations: UniCX - Your Partner in Retirement Planning &
              Financial Growth
            </h2>
            <p>
              At <strong>UniconsultX Solutions Private Limited (UniCX)</strong>,
              our commitment extends beyond providing a powerful NPS calculator.
              We understand that{" "}
              <strong>retirement planning is a long-term journey</strong>, and
              navigating its complexities requires comprehensive support. That's
              why we offer <strong>comprehensive support and resources</strong>{" "}
              to ensure your financial future is secure.
            </p>
            ...
            <ul className="list-disc list-inside space-y-1">
              ...
              <li>
                <strong>Investment Advisory:</strong> Expert advice on various
                investment avenues, including NPS, mutual funds, etc.
              </li>
              <li>
                <strong>Tax Planning:</strong> Strategies to optimize your tax
                savings through instruments like NPS, ELSS, etc.
              </li>
              <li>
                <strong>Annuity Selection Assistance:</strong> Guidance on
                choosing the right annuity plan for your post-retirement needs.
              </li>
              <li>
                <strong>Wealth Management:</strong> Holistic financial planning
            ...
            <p className="mt-4">
              <strong>Secure Your Future with UniCX:</strong> We are dedicated
              to being your reliable source for all things retirement planning.
              Explore our website for more in-depth articles, common FAQs, and
              the latest updates. Partner with UniCX for peace of mind in your
              financial journey.
            </p>
          ...
          <section className="pt-6 border-t mt-6">
            <p className="text-sm text-gray-500">
              ...
              help users simplify National Pension System projections as per
              current Indian regulations. For complex financial situations or
              personalized advice, always consult with a qualified financial
              professional or{" "}
