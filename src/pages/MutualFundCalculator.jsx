            ...
            <div className="space-y-14 text-gray-700 text-base leading-relaxed">
              ...
              <section className="">
                ...
                {/* <div className="grid lg:grid-cols-2 grid-cols-1 gap-4"> */}
                  <div>
                    <p className="mb-4 p-content">
                      Mutual funds have emerged as a preferred investment option
                      for millions due to a multitude of benefits:
                    </p>
                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-4">
                  <div>
                    ...
                    <ol className="list-decimal list-inside space-y-3">
                      ...
                      <li className="list-content">
                        <strong className="">Enter Investment Amount:</strong>
                        <ul className="list-circle list-inside ml-6 mt-1 space-y-3">
                          <li className="list-content">
              ...
              <section className="">
                ...
                <div className="space-y-2">
                  {mfFaqs.map((faq, i) => (
                    ...
                    >
                      <button
                        className={`flex justify-between items-center px-3 w-full text-left  rounded-lg py-3 ${
